...
Evidence-bearing analysis and review may add these optional fields:

```json
{
  "evidence": ["Observed fact with a named source"],
  "findings": [
    {
      "path": "optional/file.ts:42",
      "finding": "Specific defect or counterexample",
      "smallestCorrection": "Optional bounded correction"
    }
  ],
